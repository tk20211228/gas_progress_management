...
//     todayActualItem        :[Number(selectAllPlanVlales[3][todayAchievementNo]),'消化項目'],// 実績
//     todayplanUsingItem     :[Number(selectAllPlanVlales[1][todayAchievementNo]),'予定項目数'],// 計画
//     todayActualTime        :[Number(selectAllPlanVlales[4][todayAchievementNo]),'実工数'],// 実績
//     todayPlanUsingTime     :[Number(selectAllPlanVlales[2][todayAchievementNo]),'予定工数'],// 計画
...
//     tomorrowActualItem     :[Number(selectAllPlanVlales[3][nexstdayAchievementNo]),'消化項目'],// 実績
//     tomorrowPlanUsingItem  :[Number(selectAllPlanVlales[1][nexstdayAchievementNo]),'予定項目数'],// 計画
//     tomorrowActualTime     :[Number(selectAllPlanVlales[4][nexstdayAchievementNo]),'実工数'],// 実績
//     tomorrowPlanUsingTime  :[Number(selectAllPlanVlales[2][nexstdayAchievementNo]),'予定工数'],// 計画
...
//       let body = `<label for="${key}" class="col-sm-2 col-form-label">${bodyItem[key][1]}</label><div class="col-sm-4 mb-2"><input type="date" class="form-control" id="${key}" v-model="bodyItem.${key}[0]"></div>`;
//       addBody += body;
...
//     }
//     else{
//       let body = `<label for="${key}" class="col-sm-3 col-form-label">${bodyItem[key][1]}</label><div class="col-sm-3 mb-2"><input type="number" class="form-control" id="${key}" v-model="bodyItem.${key}[0]"></div>`;
//       addBody += body;
//       };
//     };
